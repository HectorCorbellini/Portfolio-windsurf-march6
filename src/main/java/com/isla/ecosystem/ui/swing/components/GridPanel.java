...
/**
 * Panel responsible for rendering the simulation grid.
 * Handles all grid visualization logic including entity representation and statistics display.
 */
public class GridPanel extends JPanel {
    ...
    private void drawPlaceholder(Graphics g) {
        ...
        g.drawString("Simulation not started - Set initial animal and plant counts using the buttons above",
    ...
    public Dimension getPreferredSize() {
        ...
        return new Dimension(
            ...
            PADDING * 2 + grid.getHeight() * CELL_SIZE + 30
        );
    }
} 